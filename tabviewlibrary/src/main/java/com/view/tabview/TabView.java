...
public class TabView extends RelativeLayout {
    ...
    private void initDefaultAttrs(Context context){
        ...
        mTabViewHeight= TabViewHelper.dp2px(context,52);
        mImageViewTextViewMargin= TabViewHelper.dp2px(context,2);
        mTextViewSize= TabViewHelper.sp2px(context,14);
        mImageViewWidth= TabViewHelper.dp2px(context,30);
        mImageViewHeight= TabViewHelper.dp2px(context,30);
    ...
    public void setTextViewSize(int size){
        this.mTextViewSize= TabViewHelper.sp2px(getContext(),size);
    }
